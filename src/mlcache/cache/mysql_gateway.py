"""MySQL-first semantic cache gateway."""
...
from mlcache.persistence.mysql import MySQLCacheRepository
from mlcache.semantic_types import CacheEntry, CacheKey, CacheLookup, Response


class MySQLSemanticCacheGateway(SemanticCacheGateway):
    """Gateway that makes MySQL the source of truth for writes and deletes."""
...
__all__ = ["MySQLSemanticCacheGateway"]
