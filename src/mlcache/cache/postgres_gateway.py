"""PostgreSQL-first semantic cache gateway."""
...
class PostgresSemanticCacheGateway(SemanticCacheGateway):
    """Gateway that makes PostgreSQL the source of truth for writes and deletes."""
...
__all__ = ["PostgresSemanticCacheGateway"]
