...
from mlcache.scorers.utils import as_matrix, feature_vector, labels, np_module
from mlcache.semantic_types import LabeledPairBatch, ScorerName, Score
...
class TinyMLPScorer(BaseScorer):
    ...
    def copy_for_refit(self):
        return type(self)(hidden_layer_sizes=self.hidden_layer_sizes, max_iter=self.max_iter)
